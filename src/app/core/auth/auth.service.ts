...
export class AuthService {
    ...
    signIn(credentials): Observable<any> {
        ...
        return this._httpClient.post(this._enveronmentApiUrl + 'user/login', credentials).pipe(
    ...
    signOut(): Observable<any> {
        ...
        this._httpClient.post(this._enveronmentApiUrl + 'user/logOut?id=' + id, {}).subscribe(response => {
    ...
    public getErrors(msg) {
        if (msg == 'Server Error') {
            return 'सर्व्हर त्रुटी'
        } else if (msg == 'User Not Exists..!') {
            return 'वापरकर्ता अस्तित्वात नाही..!'
        }else {
            return msg
        }
    }
